@component('laravel-crm::components.card')
    ...
    @component('laravel-crm::components.card-header')
        ...
        @slot('actions')
            ...
            @can('edit crm leads')
                <a href="{{ url(route('laravel-crm.leads.edit', $lead)) }}" type="button"
            ...
            @can('delete crm leads')
                <form action="{{ route('laravel-crm.leads.destroy',$lead) }}" method="POST"
                    ...
                    <button class="btn btn-danger btn-sm" type="submit"
                            data-model="{{ __('laravel-crm::lang.lead') }}">
            ...
            <div class="row">
                <div class="col-8" style="border-right: 1px gainsboro solid">
                    ...
                    <form method="POST" action="{{ url(route('laravel-crm.leads.update', $lead)) }}">
                        ...
                        <div style="margin-top: 10px; padding-top: 20px; border-top: 1px gainsboro dashed">
    ...
    @component('laravel-crm::components.card-footer')
        {{--            <a href="{{ url(route('laravel-crm.leads.index')) }}" class="btn btn-outline-secondary"--}}
